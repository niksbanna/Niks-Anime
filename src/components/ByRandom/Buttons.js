    ...
    return (
        <div>
            <div className="flex items-center justify-center pa4">
                {/* <a onClick={handleOnClick} href="#0" className="f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box mr4">
                ...
                <a onClick={handleOnClick} href="#0" className="link f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box">
                    <span className="pr1">Random</span>
